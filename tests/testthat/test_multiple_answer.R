...
test_that("a multiple answer option is added correctly", {
  ...
  expect_true(exists("test_a__test_b__test_c", envir=surveys::multiple_answer_choices))
  info <- get("test_a__test_b__test_c", envir=surveys::multiple_answer_choices)
...
test_that("multiple answer options are added correctly", {
  ...
  expect_true(exists("test_a__test_b__test_c__test_d", envir=surveys::multiple_answer_choices))
  info <- get("test_a__test_b__test_c__test_d", envir=surveys::multiple_answer_choices)
  expect_equal(info$options, choices)
